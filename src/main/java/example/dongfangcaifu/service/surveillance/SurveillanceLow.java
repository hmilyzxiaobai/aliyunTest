...
@Service
@Slf4j
public class SurveillanceLow {


    /**
     * 思路： 之前一个星期有三个以上超百分之8的涨幅或者涨停
     */
...
//            dataAll=dataAll.replaceAll("\\);","");
            ...
            for(int i=0;i<objects.size();i++){
                ...
                // 保存实时信息
                addSaveCodeDfList(公司代码,公司名字,今天开,当日最低,昨天收,涨跌幅,涨跌额,最新价格,当日最高);
    ...
    private synchronized void addSaveCodeDfList(String code,String name
            ...
            ,String earnAmount,String nowPrice,String top){
        /**
