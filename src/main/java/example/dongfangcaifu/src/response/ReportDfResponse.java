...
public class ReportDfResponse implements Serializable {
	...
	@ApiModelProperty(value = "影响趋势 -10 --- 10 负数为负面影响 正数为正面影响", position = 6)
	private String influence;

	@ApiModelProperty(value = "影响公司的code", position = 7)
	private String influenceCompanyCode;

	@ApiModelProperty(value = "影响行业的code", position = 8)
