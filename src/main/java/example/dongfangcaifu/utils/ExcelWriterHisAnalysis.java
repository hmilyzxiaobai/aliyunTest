...
public class ExcelWriterHisAnalysis {

    public static void ExcelWriteAnalysis(
       ...
       // String[] headers = {"Data Time", "Company Name", "Company Code", "Plate","Plate Name","Code Change","Plate Change","Code Percent","Plate Percent"};
        ...
        // 指定输出文件夹和文件名
        String outputFolder = "D:\\dataAIExcel\\"+pathDf; // 替换为你想要的文件夹路径
        folderCreatorLegacy(outputFolder);
        String fileName = plateName+"-"+conceptCode+df+".xlsx";
